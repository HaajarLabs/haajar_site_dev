...
const Haajar = () => {
  return (
    <div className="relative lg:h-screen h-fit flex  mx-auto bg-[#F43F5E] lg:pt-6 ss:py-16 xs:py-12 px-3 lg:pl-28 lg:pb-6 justify-between overflow-hidden ">
      <div
        data-aos="fade-down"
        data-aos-once="true"
        data-aos-delay="800"
      ...
      <div className="lg:mt-40 lg:w-3/6 flex flex-col items-center">
        <h1
          ...
          data-aos-once="true"
          data-aos-duration="1000"
          className="ss:text-5xl xs:text-3xl font-bold mb-6 font-vilane_Regular text-white"
        >
          Why Haajar ?
        </h1>
        <p
          ...
          data-aos-delay="400"
          data-aos-duration="1000"
          className=" bg-white text-center lg:text-2xl ss:text-xl leading-loose tracking-wider text-[#6E6E6E] rounded-lg   font-vilane_Medium  shadow-2xl p-8 lg:p-12"
        >
