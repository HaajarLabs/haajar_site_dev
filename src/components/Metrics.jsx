...
const Metrics = ({ metrics }) => {
  return (
    ...
    <h2 className="md:text-md xs:text-xs font-semibold mb-4 xs:px-2 ss:px-0">Arrived <span className="xs:hidden ss:block">Appointments</span></h2>
    ...
    {/* <img className="absolute hidden lg:flex bottom-0 right-[-80px] top-5  w-56  opacity-70" src={bg3} alt="queue" /> */}
      ...
      <div className="relative flex-1 bg-white shadow-md hover:shadow-lg rounded-lg md:p-6 ss:p-4 overflow-hidden">
    <h2 className="md:text-md xs:text-xs font-semibold ss:px-0 mb-4 xs:px-2">Upcoming  <span className="xs:hidden ss:block">Appointments</span></h2>
...
<div className="relative flex-1 bg-white shadow-md hover:shadow-lg rounded-lg md:p-6 ss:p-4  overflow-hidden">
    <h2 className="md:text-md xs:text-xs font-semibold mb-4 xs:px-2 ss:px-0">Whatsapp  <span className="xs:hidden ss:block">Bookings</span></h2>
