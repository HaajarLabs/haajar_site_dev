...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex items-center '><img src={logoicon} className="w-9 animate-flipbottom transition-opacity duration-1000" alt="logo" /><img   src={isFlipped ? logo1 : logo2} className="w-28 ease-linear transition-opacity duration-1000" alt="logo" /></div>
