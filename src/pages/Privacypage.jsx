...
return (
    <div className="py-10 font-poppins bg-primary  px-10">
        ...
        <p className="text-gray-600 px-1">Updated on May 16, 2024</p>
        <p className="text-gray-600 px-1 pt-2">Last updated: May 16, 2024</p>
        <p className="pt-2 px-1 w-1/2">
            <strong>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</strong> <br /><br />

            We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the . <br /><br />
            ...
            <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Haajar. <br /><br />
            ...
            <strong>Country</strong> refers to: Kerala, India <br /><br />
            ...
            <strong>Website</strong> refers to Haajar, accessible from <br /><br />
            ...
            <strong>First name and last name</strong> <br /><br />

            <strong>Phone number</strong> <br /><br />

            <strong>Usage Data</strong> <br /><br />

            <strong>Usage Data</strong> is collected automatically when using the Service. <br /><br />
            ...
            Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the article. <br /><br />
            ...
            <strong>To provide and maintain our Service, including to monitor the usage of our Service.</strong> <br /><br />
            ...
            <strong>To provide You with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.</strong> <br /><br />
            ...
            <strong>With Service Providers:</strong> We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You. <br /><br />

            <strong>For business transfers:</strong> We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company. <br /><br />
            ...
            <strong>With business partners:</strong> We may share Your information with Our business partners to offer You certain products, services or promotions. <br /><br />

            <strong>With other users:</strong> when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside. <br /><br />

            <strong>With Your consent:</strong> We may disclose Your personal information for any other purpose with Your consent. <br /><br />
            ...
            <strong>Comply with a legal obligation</strong> <br /><br />

            <strong>Protect and defend the rights or property of the Company</strong> <br /><br />

            <strong>Prevent or investigate possible wrongdoing in connection with the Service</strong> <br /><br />

            <strong>Protect the personal safety of Users of the Service or the public</strong> <br /><br />

            <strong>Protect against legal liability</strong> <br /><br />
